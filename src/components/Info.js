            ...
            <li className="grid items-center grid-cols-12 py-2">
              ...
              <div className="w-full col-span-8 pl-4 text-lg leading-loose text-left border-l-2 border-gray-500">
                <div className="relative w-full py-1">
                  ...
                  <div className="ml-[22px] leading-normal break-keep">
                    미국인들과 만날 때 이름을 불러주고 대화에서 눈맞춤을 하는
                    것이 중요합니다. 또한 small talk를 주기도 하고 받기도
                    함으로써 자신을 알리고 상대방을 알아나가는 노력이 중요하며,
                    공식적 미팅 혹은 비공식적인 네트워킹 이후 반드시 follow up을
                    해두는 것이 좋습니다. 미국에서 사업하시다 보면 언제 어떤
                    사람이 필요하게 될지 모릅니다. 늦었다고 생각하지 말고
                    지금부터라도 자신만의 네트워크를 갖추는 노력이 필요합니다.
                  </div>
                </div>
              </div>
            </li>
